...
# hab_test_9:
#   - burnin: 26d5c2d6-395e-4480-948e-a0288f7801e0
#   - pickup: 3207ddf7-ec60-47a3-943f-5866d286218b
# hab_test_10: Narrowing down range for sapone
#   - burnin: 1b7f33a3-e374-4fde-bdca-c1312a19abba
#   - pickup: 36194196-8681-451d-8c9b-6bf7f9100ffb
#
######################################################################################################################
######################################################################################################################
######################################################################################################################
...
step = 'calibrate'                                                      # Which step of the process: setup_climate? setup_migration? 
...
exp_label = 'hab_test_10'                                                 # added label for outputs
burnin_id = '1b7f33a3-e374-4fde-bdca-c1312a19abba'                      # Single-Node Ex. hab_sweep_1 (site 'sapone' with climate from 2018)
pickup_id = '36194196-8681-451d-8c9b-6bf7f9100ffb'                      # 
...
report_years = 10                                                       # Limit to final n years of pickup in non-InsetChart reports of pickup
##### Climate ###########################################################
######################################################## Date range #####
climate_start = "2010"                                                  # From Day 1 of this year ...
...
scale_water_veg = list(np.logspace(-0.5,0.7,9)) + [0]                     # Amount of Water_Vegetation relative to Constant 
scale_temp_rain = list(np.logspace(0,2.7,10))                             # Amount of Temporary_Rainfall relative to Constant 
scale_constant = [1.0]                                                  # Amount of Constant relative to Base of 5e5. Typically left as [1.0] 
xTLH_range = list(np.logspace(0.6,0.9,10))                              # Note: x_Temporary_Larval_Habitat scales ALL habitat types, including constant
                                                                        # 
